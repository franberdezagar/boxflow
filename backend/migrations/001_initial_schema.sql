...
CREATE TABLE IF NOT EXISTS "turnos" (
  ...
  "efectivo_inicial_blanco" NUMERIC(12,2) NOT NULL DEFAULT 0.00,
   "efectivo_inicial_efectivo" NUMERIC(12,2) NOT NULL DEFAULT 0.00,
   "efectivo_final_blanco_esperado" NUMERIC(12,2),
   "efectivo_final_efectivo_esperado" NUMERIC(12,2),
   "efectivo_final_blanco_declarado" NUMERIC(12,2),
   "efectivo_final_efectivo_declarado" NUMERIC(12,2),
  "notas" TEXT,
...
CREATE TABLE IF NOT EXISTS "movimientos" (
  ...
  "categoria" VARCHAR(20) NOT NULL CHECK ("categoria" IN ('VENTA', 'PROVEEDOR', 'SUELDO', 'VARIOS')),
   "condicion_fiscal" VARCHAR(10) NOT NULL CHECK ("condicion_fiscal" IN ('BLANCO', 'EFECTIVO')),
